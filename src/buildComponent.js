...
/**
 * Template function to build configuration objet to built widget class.
 * @param {string} prop 
...
function createComponent({
  ...
  name = 'Widget',
  config = {} } = {}
  // selectorFacotry : select among constructing presentational, provider, interactive

) {

  invariant(
    Boolean(type),
    'createComponent expects `type` property on argument object'
  )
  ...
  wrappeComponent.displayName = name
  ...
  function wrappeComponent(arg) {
    ...
    if (!arg) {
      return PresentionalContent
    }

    const { state, context } = arg;

    // need to split this 
    // return selectConstructors(
    //   { state, },
    //   { context },
    //   { presentional: true, PresentionalContent }
    // )
    ...
    if (context) return ProviderContent();



    /**
     *  REFACTORISATIO OF CREATECOMPONENT
     * 
     */

    /*****************************************************************
     *      PROVIDER CONTENT CONSTRUCTOR 
     * 
     *****************************************************************/
    ...
    /*****************************************************************
   *      PRESENTIONAL CONTENT CONSTRUCTOR 
   * 
   *****************************************************************/

    function presentionalContentTemplateMethod(arg) {
      return {}
    }

    function PresentionalContent(props) {
      let { children } = props;
      return createElement(type, {
        ...presentionalContentTemplateMethod(config),
      },
        children)
    }
     ...
     * The widget properties could be following an event 
     * classname, arria attribute and so on
     */
    ...
    *****************************************************************/
    ...
    class StateFullContent extends React.Component {
      constructor(props) {
        super(props);
        this.state = {
          ...state
